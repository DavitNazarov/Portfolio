...
export default function ExperienceCard({ exp, index, total }) {
  ...
  return (
    <SpotlightCard tint={EXPERIENCE_TINT} delay={index * 0.08} className="p-5 sm:p-7">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex min-w-0 items-start gap-3.5">
            <div className="relative shrink-0">
              <div
                ...
                style={{ background: `rgba(${EXPERIENCE_TINT}, 0.4)` }}
              />
              <div
                className="relative flex h-11 w-11 items-center justify-center rounded-2xl border"
                style={{
                  borderColor: `rgba(${EXPERIENCE_TINT}, 0.3)`,
                  backgroundColor: `rgba(${EXPERIENCE_TINT}, 0.14)`,
                  boxShadow: "inset 0 1px 0 rgba(255,255,255,0.08)",
                }}
              >
                <Briefcase className="h-[18px] w-[18px]" style={{ color: `rgb(${EXPERIENCE_TINT})` }} />
              </div>
            </div>
          ...
          <div className="flex shrink-0 flex-col items-end gap-2">
            <div
              ...
              style={{
                borderColor: `rgba(${EXPERIENCE_TINT}, 0.2)`,
                backgroundColor: `rgba(${EXPERIENCE_TINT}, 0.08)`,
                color: `rgba(${EXPERIENCE_TINT}, 0.9)`,
              }}
            >
          ...
          <div className="flex flex-wrap gap-1.5">
            {tech.map((item, techIndex) => (
              <motion.span
                ...
                transition={{ duration: 0.35, delay: 0.2 + techIndex * 0.03 }}
                ...
                style={{
                  borderColor: `rgba(${EXPERIENCE_TINT}, 0.18)`,
                  backgroundColor: `rgba(${EXPERIENCE_TINT}, 0.07)`,
                }}
              >
                {item}
              </motion.span>
